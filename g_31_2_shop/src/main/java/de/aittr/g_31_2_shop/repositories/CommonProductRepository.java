...
import static de.aittr.g_31_2_shop.repositories.DBConnector.*;
...
//    INSERT INTO `31_2_shop`.`product` (`name`, `price`, `is_active`) VALUES ('test', '200', '0');
//    INSERT INTO `product` (`name`, `price`, `is_active`) VALUES ('Test', '100', '1');
    @Override
