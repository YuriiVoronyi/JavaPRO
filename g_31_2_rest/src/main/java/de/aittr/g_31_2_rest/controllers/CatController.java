...
public class CatController {
    ...
    //http//12.34.56.78:8080/cows - не существующий эндпоинт - клиент получит 404
...
//    @GetMapping("/{id}")
//    public Cat getByIg(@PathVariable int id) {
//        return service.getById(id);
//    }

    // 2 способ получения кота по ИД - передача ИД как параметра запроса
    // http//12.34.56.78:8080/cats?id=3&color=Gray
    @GetMapping("/get")
    public Cat getByIg(@RequestParam int id) {
        return service.getById(id);
    }
